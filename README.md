...
Where <img src="https://latex.codecogs.com/gif.latex?_{L(t)}"> is the loss at time t. <img src="https://latex.codecogs.com/gif.latex?_{L(\infty)}"> is the Ultimate loss.  <img src="https://latex.codecogs.com/gif.latex?\lambda"> and <img src="https://latex.codecogs.com/gif.latex?\omega"> are parameters.  
